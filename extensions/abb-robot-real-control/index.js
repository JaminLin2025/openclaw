...
function buildLogDiagnosis(logEntries, status, tasks, errorHint) {
  ...
  if (joined.includes("semantic") || joined.includes("mainmodule") || joined.includes("resetpp") || joined.includes("行") || joined.includes("错误")) {
    ...
    recommendations.push("If MainModule has syntax errors, fix RAPID source and use load_rapid before start_program.");
